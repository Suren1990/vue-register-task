    ...
    <div class="max-w-[30rem] w-[100%] mx-auto">
        ...
        <div v-if="registeredSuccess">
            ...
            <button 
                ...
                class="w-[100%] h-[2.5rem] bg-green-500 text-white hover:bg-green-600"
            >Go Login</button>
        </div>
        <form v-else class="flex flex-col mb-4 p-3 border border-green-500 rounded-xl" @submit.prevent="submitForm">
            <label class="mb-4">
                ...
                <input type="text" class="w-[100%] p-2 border border-green-400 rounded-md outline-0 input_focus"
            ...
            <label class="mb-4">
                ...
                <input
                  ...
                  class="w-[100%] p-2 border border-green-400 rounded-md outline-0 input_focus"
                  type="email"
                  :class="{ 'border-red-600': v$.email.$error && v$.email.$touch }" 
                  @blur="v$.email.$touch"
                >
            ...
            <label class="mb-4">
                ...
                <input
                  ...
                  class="w-[100%] p-2 border border-green-400 rounded-md outline-0 input_focus"
                  type="password"
                  :class="{ 'border-red-600': v$.password.$error && v$.password.$touch }" 
            ...
            <label class="mb-4">
                ...
                >
                <div v-if="formData.password !== formData.confirmPassword" class="text-red-600 font-bold">Confirm password must equal to password</div>
            ...
            <button type="submit"
                class="h-10 text-xl bg-green-500 text-white rounded-md hover:bg-green-600">Register</button>
        </form>
    </div>
</template>
